...
//   description: {
//     short:
//       'Bhang® Milk Chocolate starts with sustainably-sourced and fair-trade cacao
//        and is Powered by INDIVA™. Produced in Indiva’s state-of-the-art facility
//        based in London, Ontario, and backed by a fifth generation chocolatier,
//        Bhang® MilkChocolate offers a cannabis-free flavour that offer just the right
//         hint of sweetness.',
//     completion:
//       'Cannabis-infused edible products combine cannabis distillate with premium
//        ingredients. They offer the same delayed onset time and smoke-free experience
//        of capsules and oils, packaged within a tasty snack..',
//   },
//   reviews: [
//     {
...
//           Quis auctor elit sed vulputate mi. In nulla posuere sollicitudin aliquam ultrices.',
...
//       feedback:
//         'I actually take a half of one cause the first time I took a full one and
//        I felt a little too good lol but it’s very manageable with the half dose.
//       Then I can still get stuff done and go about my day but I just enjoy it a little more.',
//       benefit: '',
//       disadvantages: '',
//     },
//   ],
...
//     ingredients:
//       'MILK CHOCOLATE (SUGAR, HYDROGENATED PALM KERNEL OIL, NONFAT DRY MILK, COCOA
//        PROCESSED WITH ALKALI, SORBITAN MONOSTEARATE, LACTIC ACID ESTERS OF MONO AND
//         DIGLYCERIDES WITH CITRIC ACID TO PROTECT FLAVOR, SOY LECITHIN (AN EMULSIFIER),
//         ARTIFICIAL FLAVOR), MCT OIL, HEMP EXTRACT',
//     flavors: 'MAY CONTAIN PEANUTS, TREE NUTS, MILK CHOCOLATE',
//     recommendedUsage:
//       'Begin with a small portion, wait for the effects to kick in, and then decide
//        if you want to consume more.',
//   },
// };
...
SingleProductSwiper.defaultProp = {
  product: { },
  imageUrls: '',
};
